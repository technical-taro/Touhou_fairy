...
def main():
    global screen, enemy_paths, tmr, screen_size, keys, bullet, key_space
    ...
    while True:
        ...
        for enemy_check in enemies_list:
            if pygame.sprite.collide_rect(enemy_check, bullet):
    ...
    def __init__(self):
        ...
        for row in self.split_point_x:
            for size in self.split_point:
                self.surface = pygame.Surface(size[1], pygame.SRCALPHA)#pygame.SRCALPHA
