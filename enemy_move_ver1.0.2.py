...
class Enemy:
    ...
    def built(self):
        ...
        #self.hp_shows(5, (255, 0, 0))
        #self.hp_shows(0, (255,255, 255))
        ...
        #pygame.draw.arc(screen, (255, 255, 255), [self.x - 28, self.y - 28, enemy_paths[self.loaded_enemy][2][0]+56, enemy_paths[self.loaded_enemy][2][1] + 56], maths.pi*1/2, 5/2*maths.pi*(self.current_hp/self.enemy_hp), 2)
    ...
    def hp_shows(self, behind_mode, color):
        
        self.center_point = [self.x + enemy_paths[self.loaded_enemy][2][0]/2, self.y + enemy_paths[self.loaded_enemy][2][1]/2]
        pygame.draw.arc(screen, color, [center_point[0] - radius, center_point[1] - radius, 2*radius, 2*radius], maths.radians(90), maths.radians(90+360*(self.current_hp/self.enemy_hp)), 3+behind_mode)
...
class Bullet(pygame.sprite.Sprite):
    """
    チルノの弾は縦59pixel,横20pixel
    """
    def __init__(self):
        self.x = 0
        self.y = 0
        self.image_size = (59, 20)
        self.image_path = "chara\\自機チルノ\\CirnoBullet.png"
    def shoot(self):
        pass
